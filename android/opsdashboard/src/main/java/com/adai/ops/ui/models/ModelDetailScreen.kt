...
// @adai-status: beta        (TD-048 — ModelDetailScreenConfirmActionTest.kt now covers the admin-action confirm-dialog flow; real-device run still unverified, see below)
// @adai-version: 0.3.0
