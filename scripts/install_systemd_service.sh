#!/bin/bash
# ADAI Chatbot - systemd Service Installation Script
#
# This script installs and configures the ADAI chatbot as a systemd service.
# It creates necessary directories, users, and configuration files.
#
# Usage:
#   sudo ./install_systemd_service.sh [OPTIONS]
#
# Options:
...
#   sudo ./install_systemd_service.sh --install-path /usr/local/adai --port 9000
...
# Generated by install_systemd_service.sh on $(date)
