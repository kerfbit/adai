...
ChatbotGUI::ChatbotGUI(const std::string& vocab_file, 
    ...
    // Add welcome message
    addMessage("System", "Welcome to ADAI Transformer Chatbot!\n"
                        "Type your message and press Send or Enter to chat.", false);
}
    ...
    try {
        ...
        QMessageBox::warning(nullptr, "Initialization Warning", 
                           QString("Error during initialization: %1\n"
                                   "Using default/random initialization.").arg(e.what()));
        return false;
    }
}
...
QWidget* ChatbotGUI::createSettingsPanel() {
    ...
    strategyCombo->addItems({"Nucleus (Top-p)", "Top-k Sampling", "Greedy", "Beam Search", "Sampling"});
    strategyCombo->setCurrentText("Nucleus (Top-p)");
    connect(strategyCombo, QOverload<int>::of(&QComboBox::currentIndexChanged),
            this, &ChatbotGUI::onStrategyChanged);
    ...
    connect(temperatureSpin, QOverload<double>::of(&QDoubleSpinBox::valueChanged),
            this, &ChatbotGUI::onTemperatureChanged);
    ...
    connect(topPSpin, QOverload<double>::of(&QDoubleSpinBox::valueChanged),
            this, &ChatbotGUI::onTopPChanged);
    ...
    connect(topKSpin, QOverload<int>::of(&QSpinBox::valueChanged),
            this, &ChatbotGUI::onTopKChanged);
    ...
    connect(maxLengthSpin, QOverload<int>::of(&QSpinBox::valueChanged),
            this, &ChatbotGUI::onMaxLengthChanged);
    ...
    connect(beamWidthSpin, QOverload<int>::of(&QSpinBox::valueChanged),
            this, &ChatbotGUI::onBeamWidthChanged);
...
void ChatbotGUI::onSaveConversation() {
    QString fileName = QFileDialog::getSaveFileName(this,
        "Save Conversation", conversation_save_path.c_str(),
...
void ChatbotGUI::onLoadConversation() {
    QString fileName = QFileDialog::getOpenFileName(this,
        "Load Conversation", conversation_save_path.c_str(),
        "Text Files (*.txt);;All Files (*)");
...
void ChatbotGUI::onStrategyChanged(int index) {
    switch (index) {
        case 0: generation_strategy = "nucleus"; break;
        case 1: generation_strategy = "top-k"; break;
        case 2: generation_strategy = "greedy"; break;
        case 3: generation_strategy = "beam"; break;
        case 4: generation_strategy = "sampling"; break;
        default: generation_strategy = "nucleus"; break;
    }
}
