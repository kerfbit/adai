...
public:
    ...
    float compute_loss(const PreferencePair& pair) {
        ...
        chosen_input.insert(chosen_input.end(), 
                           pair.chosen_encoding.begin(), 
                           pair.chosen_encoding.end());
        
        std::vector<float> rejected_input = pair.prompt_encoding;
        rejected_input.insert(rejected_input.end(),
                             pair.rejected_encoding.begin(),
    ...
    void save(const std::string& filepath) const {
        ...
        file.write(reinterpret_cast<const char*>(layer_dims_.data()), 
    ...
    void load(const std::string& filepath) {
        ...
        file.read(reinterpret_cast<char*>(layer_dims_.data()),
                  num_layers * sizeof(int));
     ...
     */
    const std::vector<int>& get_layer_dims() const { return layer_dims_; }
};
