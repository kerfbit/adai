 ...
 */
inline bool is_special_token(int token_id, const SpecialTokenConfig& config = SpecialTokenConfig()) {
    return token_id == config.pad_token_id ||
           token_id == config.unk_token_id ||
           token_id == config.bos_token_id ||
...
inline bool is_special_token_string(const std::string& token_str) {
    return token_str == SpecialTokenStrings::PAD ||
           token_str == SpecialTokenStrings::UNK ||
           token_str == SpecialTokenStrings::BOS ||
           token_str == SpecialTokenStrings::EOS;
}
 ...
 */
inline std::string get_special_token_string(int token_id, const SpecialTokenConfig& config = SpecialTokenConfig()) {
    if (token_id == config.pad_token_id) return SpecialTokenStrings::PAD;
    if (token_id == config.unk_token_id) return SpecialTokenStrings::UNK;
    if (token_id == config.bos_token_id) return SpecialTokenStrings::BOS;
    if (token_id == config.eos_token_id) return SpecialTokenStrings::EOS;
 ...
 */
inline int get_special_token_id(const std::string& token_str, const SpecialTokenConfig& config = SpecialTokenConfig()) {
    if (token_str == SpecialTokenStrings::PAD) return config.pad_token_id;
    if (token_str == SpecialTokenStrings::UNK) return config.unk_token_id;
    if (token_str == SpecialTokenStrings::BOS) return config.bos_token_id;
    if (token_str == SpecialTokenStrings::EOS) return config.eos_token_id;
...
inline std::unordered_set<std::string> create_special_token_set() {
    return {
        SpecialTokenStrings::PAD,
        SpecialTokenStrings::UNK,
        SpecialTokenStrings::BOS,
...
inline std::unordered_map<std::string, int> create_special_token_map(
    ...
    return {
        {SpecialTokenStrings::PAD, config.pad_token_id},
...
inline std::unordered_map<int, std::string> create_inverse_special_token_map(
    const SpecialTokenConfig& config = SpecialTokenConfig()) {
    return {
        {config.pad_token_id, SpecialTokenStrings::PAD},
