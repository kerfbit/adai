...
void print_usage(const char* program_name) {
    ...
    std::cout << "  " << program_name << " --input data.txt --output vocab.txt --vocab-size 10000\n\n";
 ...
 */
std::vector<std::string> load_plain_text(const std::string& filename) {
...
/**
 * Load text from INPUT/RESPONSE paired format
 */
std::vector<std::string> load_pairs_format(const std::string& filename) {
    std::vector<std::string> texts;
    std::ifstream file(filename);
    ...
    std::string line;
    while (std::getline(file, line)) {
        // Extract INPUT and RESPONSE lines
...
/**
 * Load text from JSON array format
 */
std::vector<std::string> load_json_format(const std::string& filename) {
    std::vector<std::string> texts;
    std::ifstream file(filename);
    ...
    // Simple JSON array parser (expects ["text1", "text2", ...])
