...
TEST_F(BatchProcessorTest, PaddingMaskNoPadding) {
    std::vector<std::vector<int>> same_length = {
        {1, 2, 3},
        {4, 5, 6},
        {7, 8, 9}
    };
...
TEST_F(BatchProcessorTest, UnbatchOutputsValuePreservation) {
    ...
    output1(0, 0) = 1.1f; output1(0, 1) = 1.2f;
    output1(1, 0) = 2.1f; output1(1, 1) = 2.2f;
    output1(2, 0) = 9.9f; output1(2, 1) = 9.9f;  // Padding (should be removed)
    output1(3, 0) = 9.9f; output1(3, 1) = 9.9f;  // Padding (should be removed)
    batch_outputs.push_back(output1);
    
    Matrix output2(4, 2);
    output2(0, 0) = 10.1f; output2(0, 1) = 10.2f;
    output2(1, 0) = 11.1f; output2(1, 1) = 11.2f;
    output2(2, 0) = 12.1f; output2(2, 1) = 12.2f;
    output2(3, 0) = 13.1f; output2(3, 1) = 13.2f;
