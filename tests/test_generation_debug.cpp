...
int main() {
    ...
    std::string greedy_response =
        model.generate_response_with_strategy("hello", 10, "greedy", 1.0f, 50, 0.9f, 3);
    ...
    std::string beam_response =
        model.generate_response_with_strategy("hello", 10, "beam", 1.0f, 50, 0.9f, 3);
