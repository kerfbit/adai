...
void test_tokenizer_sync() {
    ...
    std::cout << "  Model bos_token_id: " << model.get_bos_token_id() << " (expected 2)"
              << std::endl;
    std::cout << "  Model eos_token_id: " << model.get_eos_token_id() << " (expected 3)"
              << std::endl;
    std::cout << "  Model pad_token_id: " << model.get_pad_token_id() << " (expected 0)"
              << std::endl;
